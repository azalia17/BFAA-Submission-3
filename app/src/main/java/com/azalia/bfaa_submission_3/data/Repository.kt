package com.azalia.bfaa_submission_3.data

import android.app.Application
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.azalia.bfaa_submission_3.data.datastore.UserDataStore
import com.azalia.bfaa_submission_3.data.local.UserDao
import com.azalia.bfaa_submission_3.data.local.UserDatabase
...
class Repository(private val application: Application) {
    ...
    suspend fun getFavoriteList(): LiveData<Resource<List<User>>> {
        ...
        if (dao.getFavoriteListUser().isNullOrEmpty()){
            listFavorite.postValue(Resource.Failure(null))
        }
